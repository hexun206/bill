 ...
 */
public class BjyPlayBackBottomViewPresenter implements IPlayerBottomContact.BottomView {
    ...
    public BjyPlayBackBottomViewPresenter(View bottomView, View.OnClickListener speedOnClick) {
        ...
        $.id(R.id.rl_play).clicked(new View.OnClickListener() {
            @Override
        ...
        $.id(R.id.rl_screen).clicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mPlayer != null) {
...
//            $.id(R.id.bjplayer_current_pos_duration_tx).gone();
            iv_screen.setBackgroundResource(R.drawable.ic_fullsc_b);
        }
    }
