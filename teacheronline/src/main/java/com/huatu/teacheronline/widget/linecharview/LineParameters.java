 ...
 *
 * @author ljyu 2017-4-28 14:05:45
 */
public class LineParameters {
    ...
    public LinkedHashMap<String, String> getDrawMap() {
        return drawMap == null ? new LinkedHashMap<String, String>() : drawMap;
    }

    public LineParameters setDrawMap(LinkedHashMap<String, String> drawMap) {
