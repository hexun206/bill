package com.huatu.teacheronline.widget.rollviewpager.adapter;
...
import com.huatu.teacheronline.widget.rollviewpager.HintView;
...
public abstract class LoopPagerAdapter extends PagerAdapter {
    ...
    public final int getCount() {
        return getRealCount() <= 1 ? getRealCount() : 1000;
    }
