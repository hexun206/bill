...
/**
 * Created by kinndann on 2018/11/12.
 * description:
 */
public class RoundProgress extends View {
    ...
    public RoundProgress(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 获取自定义属性和默认值
        roundColor = mTypedArray.getColor(R.styleable.RoundProgress_srp_roundColor, Color.RED);
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgress_srp_roundWidth, 5);
        progressColor = mTypedArray.getColor(R.styleable.RoundProgress_srp_progressColor, Color.GREEN);
        progressWidth = mTypedArray.getDimension(R.styleable.RoundProgress_srp_progressWidth, roundWidth);
        max = mTypedArray.getInteger(R.styleable.RoundProgress_srp_max, 100);
        style = mTypedArray.getInt(R.styleable.RoundProgress_srp_style, 0);
        startAngle = mTypedArray.getInt(R.styleable.RoundProgress_srp_startAngle, -90);
