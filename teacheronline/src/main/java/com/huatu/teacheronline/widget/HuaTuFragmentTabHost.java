 ...
 * the hierarchy you must call {@link #setup(Context, FragmentManager, int)} to complete the initialization of the tab host.
 * 
 * <p>
 ...
 * complete}
 */
public class HuaTuFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener
{
    ...
    public HuaTuFragmentTabHost(Context context)
    {
    ...
    public HuaTuFragmentTabHost(Context context, AttributeSet attrs)
    {
        super(context, attrs);
