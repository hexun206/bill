package com.huatu.teacheronline.widget.rollviewpager.hintview;
...
import com.huatu.teacheronline.widget.rollviewpager.Util;
...
public class IconHintView extends ShapeHintView {
    ...
    public IconHintView(Context context, @DrawableRes int focusResId, @DrawableRes int normalResId) {
        this(context, focusResId, normalResId, Util.dip2px(context, 18));
    }
