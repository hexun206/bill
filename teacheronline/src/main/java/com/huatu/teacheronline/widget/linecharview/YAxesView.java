 ...
 * 绘制Y轴线以及Y轴线上的坐标值
 *
 * @author ljyu 2017-4-28 14:06:06
 */
public class YAxesView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //设置Y轴视图的宽度，通过计算最大值的宽度然后加10，保证一定的空间 //调整y轴初始位置
        int maxWidth = (int) (paint.measureText(maxValueStrinh) + 0.5f) + lineParameters.getAxesLineWidth() - 10;
//        int maxWidth = (int) (paint.measureText(maxValueStrinh) + 0.5f) + lineParameters.getAxesLineWidth() - 50;
