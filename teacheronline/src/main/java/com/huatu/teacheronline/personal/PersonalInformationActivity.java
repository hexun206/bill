...
//    private TextView tv_nickname;
    ...
    public void initView() {
        ...
        photoUtils = new PhotoUtils(this, userid);
...
//        tv_birthday.setText(birthday);
    ...
    private static class ObtainDataFromNetListenerSaveInfo extends ObtainDataFromNetListener<PersonalInfoBean, String> {
        private PersonalInformationActivity weak_activity;

        public ObtainDataFromNetListenerSaveInfo(PersonalInformationActivity activity) {
...
//                            weak_activity.tv_nickname.setText(res.getNickname());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_sex:
                ...
                // 修改性别
                AlertDialog.Builder builder1 = new AlertDialog.Builder(PersonalInformationActivity.this);
                ...
                builder1.setSingleChoiceItems(mItems, selectPosition, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                MobclickAgent.onEvent(PersonalInformationActivity.this, "personalFemaleOnClik");
                                selectedSexPosition = 0;
                                tv_sex.setText(getResources().getString(R.string.info_sex_female));
                                dialog.dismiss();
                                break;
                            case 1:
                                MobclickAgent.onEvent(PersonalInformationActivity.this, "personalMaleOnClik");
            ...
            case R.id.rl_changePwd:
                startActivityForResult(new Intent(PersonalInformationActivity.this,ChangePwdActivity.class),101);
                break;
            case R.id.rl_mobile:
                if(flag_mobile != 2){
    ...
    private void showBirthdayDialog() {
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, R.style.FullScreenDialog, new DatePickerDialog.DatePickerDialogClickListener() {
