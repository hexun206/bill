...
public class BuyCourse {
     ...
     * 优惠数量
     */
    private Double course_preferential_quantity;
    /**
     * 优惠开始时间
     */
    ...
    private BuyCourse(Builder builder) {
    ...
    public Double getCourse_preferential_quantity() {
        return course_preferential_quantity;
    }

    public void setCourse_preferential_quantity(Double course_preferential_quantity) {
    ...
    public static final class Builder {
        ...
        public Builder course_preferential_quantity(Double course_preferential_quantity) {
            this.course_preferential_quantity = course_preferential_quantity;
            return this;
        }
        ...
        public BuyCourse build() {
            return new BuyCourse(this);
        }
    }
}
