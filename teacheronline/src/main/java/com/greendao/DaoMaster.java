...
//                        MigrationHelper.getInstance().migrate(db,DirectBeanDao.class);
                        oldVersion++;
                        break;
                    case 3:
...
//                        MigrationHelper.getInstance().migrate(db, DirectBeanDao.class,QuestionDetailDao.class);
                        oldVersion++;
                    ...
                    case 5:
                        ...
                        db.execSQL("ALTER TABLE QUESTION_DETAIL ADD COLUMN STATE_QUESTION TEXT");
...
//                        MigrationHelper.getInstance().migrate(db, DirectBeanDao.class, QuestionDetailDao.class);
                    ...
                    case 7:
                        ...
                        db.execSQL("ALTER TABLE DIRECT_BEAN ADD COLUMN ROOM_ID TEXT");
                        db.execSQL("ALTER TABLE DIRECT_BEAN ADD COLUMN SESSION_ID TEXT");
                        db.execSQL("ALTER TABLE DIRECT_BEAN ADD COLUMN STUDENT_CODE TEXT");
                        db.execSQL("ALTER TABLE DIRECT_BEAN ADD COLUMN BJYHFTOKEN TEXT");
